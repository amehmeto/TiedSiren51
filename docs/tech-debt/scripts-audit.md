...
| `prepare-worktree.sh` | `.github/scripts/start-issue.sh`, `/prepare-worktree` skill | Creates git worktrees from GitHub issues with automatic branch naming, PR, and npm ci setup |
