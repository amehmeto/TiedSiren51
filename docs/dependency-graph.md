...
flowchart TD
    subgraph PORTS["Port Definitions ✓"]
        ...
        I179["#179 ✓ selectBlockingSchedule<br/>📦 TiedSiren51"]
    end
    ...
    subgraph IMPL["Implementations"]
        ...
        I208["#208 🟢 Periodic tick<br/>📦 TiedSiren51<br/>READY"]
    end
...
flowchart LR
    subgraph DONE["Completed ✓"]
        ...
        I177["#177 ✓ SirenTier port<br/>📦 TiedSiren51"]
        I178["#178 ✓ SirenLookout port<br/>📦 TiedSiren51"]
        I179["#179 ✓ Selector<br/>📦 TiedSiren51"]
        I180["#180 ✓ Unified listener<br/>📦 TiedSiren51"]
        I181["#181 ✓ Noop tiers<br/>📦 blocking-overlay"]
    end
    ...
    subgraph READY["Ready to Start"]
        ...
        I208["#208 🟢 Periodic tick<br/>📦 TiedSiren51"]
    end
...
| **Auth** | #88, #160-161, #164, #167-168 | #89 | — | #85-87 ✓ |
...
182: [177] → READY               # blocking-overlay
...
167: []                          # Ready
168: []                          # Ready
169: [161]                       # Needs email verification
```
...
|-------|-------|------|-----------|
| Phase 1 (Foundations) | 8 | 8 | 0 ✓ |
| Phase 2 (Current) | 2 | 0 | 2 |
| Phase 3 (Wiring) | 1 | 0 | 1 |
