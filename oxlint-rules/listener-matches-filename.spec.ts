...
import rule from './listener-matches-filename.js'
...
describe('listener-matches-filename', () => {
    ...
    ruleTester.run('listener-matches-filename', rule, {
      valid: [
        ...
        // Function export
        {
          ...
          filename:
            '/project/core/block-session/listeners/on-session-started.listener.ts',
        },
        ...
        // Multi-word kebab-case
        {
          ...
          filename:
            '/project/core/strict-mode/listeners/on-strict-mode-enabled.listener.ts',
        },
        ...
        // node_modules - should skip
        {
          code: `export const wrong = () => {}`,
          filename:
            '/project/node_modules/package/listeners/on-foo.listener.ts',
        },
      ],
