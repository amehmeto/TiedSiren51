...
ruleTester.run('usecase-matches-filename', rule, {
  valid: [
    // Correct export name
    {
      ...
      filename: '/project/core/block-session/usecases/start-session.usecase.ts',
    },
    // Function export
    {
      code: `export function loadBlocklists() { return {} }`,
      filename: '/project/core/blocklist/usecases/load-blocklists.usecase.ts',
    },
    // Named export
    {
    ...
    // Multi-word kebab-case
    {
      ...
      filename: '/project/core/blocklist/usecases/validate-blocklist-form.usecase.ts',
    },
    ...
    {
      code: `export const wrong = () => {}`,
      filename: '/project/node_modules/package/core/usecases/file.usecase.ts',
    },
