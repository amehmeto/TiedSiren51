...
ruleTester.run('no-stylesheet-magic-numbers', rule, {
  ...
  invalid: [
    ...
    // Multiple magic numbers
    {
      ...
      `,
      errors: [
        { messageId: 'noMagicNumber', data: { value: 16, property: 'padding' } },
        { messageId: 'noMagicNumber', data: { value: 8, property: 'margin' } },
        { messageId: 'noMagicNumber', data: { value: 4, property: 'borderRadius' } },
      ],
    },
    // Negative number
    {
    ...
    // width and height
    {
      ...
      `,
      errors: [
        { messageId: 'noMagicNumber', data: { value: 100, property: 'width' } },
        { messageId: 'noMagicNumber', data: { value: 50, property: 'height' } },
      ],
    },
  ],
})
