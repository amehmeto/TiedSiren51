  ...
  invalid: [
      ...
      errors: [
        {
          ...
          data: { suggestedName: 'TIME_PATTERN', pattern: '/^\\d{2}:\\d{2}$/' },
        },
      ],
    },
    // Inline regex in condition - NOT OK
    {
      ...
      errors: [
        {
          messageId: 'requireNamedRegex',
          data: { suggestedName: 'DIGITS_ONLY_PATTERN', pattern: '/^\\d+$/' },
        },
      ],
    },
    // Inline new RegExp - NOT OK
    {
      ...
      errors: [
        {
          messageId: 'requireNamedRegex',
          data: { suggestedName: 'PATTERN_REGEX', pattern: 'new RegExp("^test")' },
        },
      ],
    },
    ...
    // URL-like pattern - NOT OK
    {
      code: `const isUrl = /https?:\\/\\//.test(value)`,
      errors: [
        {
          messageId: 'requireNamedRegex',
          data: { suggestedName: 'URL_PATTERN', pattern: '/https?:\\/\\//' },
        },
      ],
    },
  ],
