  ...
  invalid: [
    ...
    // Complex condition
    {
      ...
      errors: [
        {
          messageId: 'preferTernary',
          data: { condition: 'x && y', consequent: "'yes'", alternate: "'no'" },
        },
      ],
    },
    // Null check pattern
    {
      ...
      errors: [
        {
          messageId: 'preferTernary',
          data: { condition: '!x', consequent: 'null', alternate: 'x.value' },
        },
      ],
    },
    // Boolean return
    {
      ...
      errors: [
        {
          messageId: 'preferTernary',
          data: { condition: 'x > 10', consequent: 'true', alternate: 'false' },
        },
      ],
    },
...
console.log('All prefer-ternary-return tests passed!')
